...
using MyShopYK.WebUI.Tests.Mocks;
...

{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "yordan89k@gmail.com", ZipCode = "55629" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("yordan89k@gmail.com", "Forms"), null);
